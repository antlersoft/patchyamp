// This class was generated from com.antlersoft.patchyamp.db.IListContent by a tool
// Do not edit this file directly! PLX THX
package com.antlersoft.patchyamp.db;

public class ListContent extends com.antlersoft.android.dbimpl.IdImplementationBase implements IListContent {

    public static final String GEN_TABLE_NAME = "LIST_CONTENT";
    public static final int GEN_COUNT = 2;

    // Field constants
    public static final String GEN_FIELD__ID = "_id";
    public static final int GEN_ID__ID = 0;
    public static final String GEN_FIELD_JSON = "JSON";
    public static final int GEN_ID_JSON = 1;

    // SQL Command for creating the table
    public static String GEN_CREATE = "CREATE TABLE LIST_CONTENT (" +
    ...
    public static final com.antlersoft.android.dbimpl.NewInstance<ListContent> GEN_NEW = new com.antlersoft.android.dbimpl.NewInstance<ListContent>() {
        public ListContent get() {
    ...
    public String getJson() { return gen_json; }
    public void setJson(String arg_json) { gen_json = arg_json; }

    public android.content.ContentValues Gen_getValues() {
        android.content.ContentValues values=new android.content.ContentValues();
        values.put(GEN_FIELD__ID,Long.toString(this.gen__Id));
        values.put(GEN_FIELD_JSON,this.gen_json);
        return values;
    }
    ...
    public int[] Gen_columnIndices(android.database.Cursor cursor) {
        ...
        result[1] = cursor.getColumnIndex(GEN_FIELD_JSON);
        return result;
    }
    ...
    public void Gen_populate(android.database.Cursor cursor,int[] columnIndices) {
        ...
        if ( columnIndices[GEN_ID_JSON] >= 0 && ! cursor.isNull(columnIndices[GEN_ID_JSON])) {
            gen_json = cursor.getString(columnIndices[GEN_ID_JSON]);
        }
    }
    ...
    public void Gen_populate(android.content.ContentValues values) {
        ...
        gen_json = values.getAsString(GEN_FIELD_JSON);
    }
}
